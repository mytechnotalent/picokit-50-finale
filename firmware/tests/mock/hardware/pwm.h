 ...
 */
static uint16_t s_mock_pwm_levels[MOCK_PWM_MAX_GPIOS];

/**
 * @brief Recorded clock divider per PWM slice.
 */
static float s_mock_pwm_clkdiv[MOCK_PWM_MAX_SLICES];

/**
 * @brief Recorded wrap value per PWM slice.
 */
static uint16_t s_mock_pwm_wrap[MOCK_PWM_MAX_SLICES];

/**
 * @brief Recorded running flag per PWM slice.
 */
static bool s_mock_pwm_running[MOCK_PWM_MAX_SLICES];
