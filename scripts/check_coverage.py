...
def _verify_full_coverage(report: str) -> bool:
    ...
    for line in report.splitlines():
        if any(src in line for src in (
                "crc.c", "radio.c", "ir_remote.c", "status_led.c", "servo.c",
                "sensor.c", "button.c", "display.c", "chacha20.c",
                "poly1305.c", "crypto_aead.c", "blake2b.c", "argon2.c",
                "crypto_kdf.c", "envelope.c", "monitor.c")):
